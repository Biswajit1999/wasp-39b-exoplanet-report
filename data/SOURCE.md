...
| Committed path | Original ZIP entry | Git blob / original-entry SHA-256 | Windows CRLF working-tree SHA-256 |
|---|---|---|---|
| `data/spectra/eureka_transmission_spectrum.txt` | `ZENODO/TRANSMISSION_SPECTRA_DATA/EUREKA_REDUCTION.txt` | `18ab790d131d28f4ad97d5a19dc3c5787ecc12269685823bbfd0d38dfe8619a8` | `976abf995f100ed34cd1fc0f94f777b0806a068896a2ed0510815a522594c243` |
| `data/spectra/scchimeramodel.txt` | `ZENODO/MODEL_FITS/ScCHIMERA_MODEL.txt` | `45d014400577a5208f9f699a7811c0cc95aeb2c4f308583db9e90297f35cca1d` | `9a376a2e2b966b0b8280906e8d559fb611b93deceb7e6a28549cf65b1eb6cec8` |
| `data/spectra/scchimeramodel_no_co2.txt` | `ZENODO/MODEL_FITS/ScCHIMERA_MODEL_noCO2.txt` | `7d41ab15efb4350ecce93f7e646d86cf4bd0fdab559f567d8e3dac51374ff004` | `176aefe865b59c30998af820fecc7c53683769532156bd68098285bda3ae0ef4` |

The committed Git blobs match the named archive entries byte for byte. A
Windows checkout configured for line-ending conversion has the alternate CRLF
hash shown above. `python scripts/verify_data_provenance.py` accepts either
checkout representation and always verifies the LF-normalized archive identity
