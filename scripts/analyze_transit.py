"""Transit-window analysis of a real TESS SPOC light curve for WASP-39 b.
...
DATA_FILE = DATA_DIR / "tess2022112184951-s0051-0000000181949561-0223-s_lc.fits"
PLANET = "WASP-39 b"
PERIOD_DAYS = 4.0552941
EPOCH_BJD = 2455342.96913
DURATION_HOURS = 2.8032
SECTOR = 51
FIGURE_FILE = FIG_DIR / "wasp39b_tess_transit.png"
...
def main() -> dict[str, float]:
    ...
    ax.scatter(hours, (result["flux"] - 1) * 1e6, s=5, alpha=0.12, color="#0b7285", label="quality-filtered cadences")
    ...
    ax.plot(hours[order], (result["model"][order] - 1) * 1e6,
            color="#0b7285", linewidth=2.2, label="fitted box model")
    ax.axvspan(-DURATION_HOURS / 2.0, DURATION_HOURS / 2.0, color="#0b7285", alpha=0.08)
